...
- (void)shortTravButtonAction:(UIButton *)sender {
    ...
    self.step = 0.0002;
    self.count = 1;
    NSArray<NSString *> *points = @[@"39.8140990075,116.2909322977",
                                    @"39.8111403898,116.2921714783",
                                    @"39.8116266337,116.2883144617",
                                    @"39.8153804863,116.2877404690",
                                    @"39.8128216255,116.2907499075",
                                    @"39.8071926207,116.2907016277",
                                    @"39.8139177032,116.2874400616",
                                    @"39.8081404356,116.2878799438",
                                    @"39.8132707722,116.2841945887",
                                    @"39.8086431843,116.2844413519",
                                    @"39.8140948870,116.2908035517",];
